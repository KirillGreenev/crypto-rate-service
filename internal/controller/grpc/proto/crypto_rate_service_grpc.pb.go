...
const (
	RatesService_GetRates_FullMethodName = "/proto.RatesService/GetRates"
)
...
type RatesServiceClient interface {
	GetRates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RatesResponse, error)
}
...
func (c *ratesServiceClient) GetRates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RatesResponse, error) {
...
type RatesServiceServer interface {
	GetRates(context.Context, *emptypb.Empty) (*RatesResponse, error)
...
func (UnimplementedRatesServiceServer) GetRates(context.Context, *emptypb.Empty) (*RatesResponse, error) {
...
var RatesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.RatesService",
	...
	Metadata: "crypto_rate_service.proto",
}
